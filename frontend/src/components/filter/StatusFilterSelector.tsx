...
interface StatusFilterSelectorProps {
    onItemSelect: (selectedStatus: boolean | null) => void;
}

const StatusFilterSelector: React.FC<StatusFilterSelectorProps> = ({ onItemSelect }) => {
    ...
    const allItems: Item[] = [
        ...
        { _id: "active", name: "Kinh doanh", status: true },
        { _id: "inactive", name: "Ngừng kinh doanh", status: false },
    ];
